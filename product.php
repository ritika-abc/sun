            ...
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6">
                    <div class="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                        <h1 class="display-5 mb-3 "><?php echo $row['name'] ?></h1>
                            ...
                            <div class="col-12" data-wow-delay="0.1s">
                                       ...
                                       <div stylel="text-align:justify">
                                          <div class="text-center">
                                                <img src="<?php echo $row['image'] ?>" class="border border-3 p-3 border-dark rounded float-none float-lg-end shadow-lg" height="auto" width="50%" alt="">
                                          </div>
